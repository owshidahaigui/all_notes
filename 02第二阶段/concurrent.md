...
![](/home/tarena/桌面/test/month2北京老师/并发concurrent/img/4_3态.png)
...
![](/home/tarena/桌面/test/month2北京老师/并发concurrent/img/4_5态.png)
...
***代码示例：day3/unix_recv.py***                      
***代码示例：day3/unix_send.py***
...
***代码示例: day4/dead_lock.py***                          
***代码示例: day4/dead_lock1.py***
...
3. 进程空间多里，数据互不干扰，有专门通信方法；线程使用全局变量通信
