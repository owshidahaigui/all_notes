...
## 3. 常用结构标签
  ...
  - 表单标签
    ...
    <form action="login" method="post" enctype="">
    	<p>
    		普通文本框text : <input type="text" name="username" placeholder="用户名由数字和字母组成" maxlength="10">
    	</p>
    	<p>
    		密码框password : <input type="password" placeholder="请输入密码">
    	</p>
    	<p>
            <!-- 一组按钮的控件名称必须保持一致-->
    		单选按钮radio : <input id="male" type="radio" name="gender" value="male" checked><label for="male">男</label>
    	...
    	<p>
    		文件选择框file : <input type="file" name="uimg">
    	</p>
        <p>
    		下拉菜单select :
    	...
    	<p>
    		多行文本域 : <textarea name="uinfo"></textarea>
    	</p>
    	<p>
    		<!-- 功能按钮-->
    		...
    		<input type="reset">
    		<input type="button">
    		<button>表单内等价于submit</button>
    	</p>
    </form>
     ```
    效果图如下：

    ![2019-04-26_115946](C:\Users\Python\Desktop\2019-04-26_115946.png)
